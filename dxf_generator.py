def generate_dxf(
    ...
    import geopandas as gpd, osmnx as ox, math, re
    from shapely.ops import unary_union, linemerge
    import ezdxf

    pt = gpd.GeoDataFrame(geometry=[Point(easting, northing)], crs=crs_nad83)
    buffer_distance = buffer_miles * 1609.34  # convert miles → meters
    ...
    out_dxf = f"{safe_name}{county_tag}_VicinityMap_1in{drawing_scale}ft_N83G.dxf"
